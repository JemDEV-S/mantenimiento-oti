<x-layouts.app title="Editar Permiso" moduleLabel="Administración" pageTitle="Editar Permiso">

    <x-ui.page-header
        :title="'Editar: ' . $permission->name"
        description="Modifica el nombre de este permiso."
    >
        <x-slot:actions>
